...
\\
\textbf{Results:}
To improve the scalability issue with the number of reference strains, the upgraded version {\tt DEploid-LASSO} can take thousands of reference strain, shrink and optimise for the target. With several new adjustments to the pipeline, we introduce the latest best practice --- {\tt DEploid-Best} for unknown mixed genome deconvolution.
\\
