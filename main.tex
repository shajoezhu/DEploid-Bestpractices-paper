...
\citet{Zhu2017,Zhu2019} have conducted series of simulation studies and validations on both {\it in vitro} and {\it in silico} mixed genomes to mimic real-world epidemiological scenario. Here are some general lessons in mixed infection deconcolution:
\begin{enumerate}
  ...
  \item In practice, certain executation orders perform better than the others:
  \begin{enumerate}
