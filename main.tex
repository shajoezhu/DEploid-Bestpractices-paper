...
\begin{enumerate}
  ...
  \item Inferring number of strains and relative abundance do not require whole genome data. Several hunderds of high quality single nucleotide polymorphism sites (SNPs) are sufficient:
    \begin{enumerate}
...
\end{equation*}
  ...
  \end{equation*}
  In practice, \texttt{DEploid} uses Markov chain Monte Carlo (MCMC) approaches. Certain executation orders perform better than the others:
...
% observation k_1, k_2. if k_1 <= k_2, any pair of sum of p_2 belongs to p_1
% [p_chromi], [p_chromj]
