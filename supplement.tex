...
% The Pf3k data set is made up with four main data
Given the source of these samples, Pf3k data set can be divided into four main parts:
\begin{itemize}
  \item \bf{Field samples} 2,375 samples from multiple sampling sites in Africa and Asia, contributed by a number of P. falciparum Community Project partner studies \citep{Duffy2015,Kamau2015,eLife2016,Mobegi2014,Amato2017,Miotto2013,Ocholla2014,Amambua-Ngwa2012} and 137 samples from Senegal that were contributed by the Broad Institute (link is external)\citep{Wong2017}

  \item \bf{Lab clonal samples} 5 lab clonal samples (7G8, GB4, KH02, KE01, GN01) used for validation

  \item \bf{Lab crosses samples} 96 crosses samples comprising parents and progeny from the P. falciparum Genetic Crosses project \citep{Miles2016}

  \item \bf{Lab mixed samples} 27 mixed lab strains in varying proportions created by Dr Jason Wendler \citep{Wendler2015}
